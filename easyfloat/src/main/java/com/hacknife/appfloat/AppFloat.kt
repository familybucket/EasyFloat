...
import com.hacknife.appfloat.interfaces.*
import com.hacknife.appfloat.interfaces.OnPermissionResult
import com.hacknife.appfloat.permission.PermissionUtils
import com.hacknife.appfloat.utils.LifecycleUtils
import com.hacknife.appfloat.interfaces.FloatCallbacks
import com.hacknife.appfloat.utils.Logger
import com.hacknife.appfloat.widget.activityfloat.ActivityFloatManager
import com.hacknife.appfloat.widget.appfloat.FloatManager
...
class AppFloat {
    ...
    companion object {
        ...
        @JvmStatic
        fun with(activity: Context): AppFloat.Builder {
            if (activity is Activity) AppFloat.Companion.activityWr = WeakReference(activity)
            return AppFloat.Builder(activity)
        }
        ...
        fun dismiss(activity: Activity? = null, tag: String? = null) =
            AppFloat.Companion.manager(activity)?.dismiss(tag)

        @JvmStatic
        @JvmOverloads
        fun hide(activity: Activity? = null, tag: String? = null) =
            AppFloat.Companion.manager(activity)?.setVisibility(tag, View.GONE)

        @JvmStatic
        @JvmOverloads
        fun show(activity: Activity? = null, tag: String? = null) =
            AppFloat.Companion.manager(activity)?.setVisibility(tag, View.VISIBLE)

        @JvmStatic
        @JvmOverloads
        fun setDragEnable(activity: Activity? = null, dragEnable: Boolean, tag: String? = null) =
            AppFloat.Companion.manager(activity)?.setDragEnable(dragEnable, tag)

        @JvmStatic
        @JvmOverloads
        fun isShow(activity: Activity? = null, tag: String? = null) =
            AppFloat.Companion.manager(activity)?.isShow(tag)
        ...
        fun getFloatView(activity: Activity? = null, tag: String? = null) =
            AppFloat.Companion.manager(activity)?.getFloatView(tag)
        ...
        private fun manager(activity: Activity?) =
            (activity
                ?: AppFloat.Companion.activityWr?.get())?.run { ActivityFloatManager(this) }
        ...
        fun appFloatIsShow(tag: String? = null) =
            AppFloat.Companion.getConfig(tag) != null && AppFloat.Companion.getConfig(tag)!!.isShow
        ...
        @JvmStatic
        @JvmOverloads
        fun getAppFloatView(tag: String? = null): View? =
            AppFloat.Companion.getConfig(tag)?.layoutView
        ...
        fun filterActivity(activity: Activity, tag: String? = null) =
            AppFloat.Companion.getFilterSet(tag)?.add(activity.componentName.className)

        @JvmStatic
        @JvmOverloads
        fun filterActivities(tag: String? = null, vararg clazz: Class<*>) =
            AppFloat.Companion.getFilterSet(tag)?.addAll(clazz.map { it.name })

        @JvmStatic
        @JvmOverloads
        fun removeFilter(activity: Activity, tag: String? = null) =
            AppFloat.Companion.getFilterSet(tag)?.remove(activity.componentName.className)

        @JvmStatic
        @JvmOverloads
        fun removeFilters(tag: String? = null, vararg clazz: Class<*>) =
            AppFloat.Companion.getFilterSet(tag)?.removeAll(clazz.map { it.name })

        @JvmStatic
        @JvmOverloads
        fun clearFilters(tag: String? = null) = AppFloat.Companion.getFilterSet(tag)?.clear()
        ...
        private fun getFilterSet(tag: String?) = AppFloat.Companion.getConfig(tag)?.filterSet
    }
    ...
    class Builder(private val activity: Context) : OnPermissionResult {
        ...
        fun setTouchEnable(touchEnable: Boolean) = apply { config.touchEnable = touchEnable }
