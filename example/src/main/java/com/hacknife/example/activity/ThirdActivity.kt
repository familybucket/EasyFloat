...
import com.hacknife.appfloat.anim.AppFloatDefaultAnimator
...
import com.hacknife.appfloat.interfaces.OnFloatCallbacks
import com.hacknife.appfloat.interfaces.OnInvokeView
import com.hacknife.appfloat.utils.DisplayUtils
import com.hacknife.appfloat.utils.InputMethodUtils
...
class ThirdActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        changeBackground.setOnClickListener {
            AppFloat.getAppFloatView()?.apply {
        ...
        recoverBackground.setOnClickListener {
            AppFloat.getAppFloatView()?.findViewById<RelativeLayout>(R.id.rlContent)
    ...
    private fun showFloat() {
        ...
        AppFloat.with(this).setLayout(R.layout.float_app).show()
        ...
        AppFloat.with(this)
            ...
            .setDisplayHeight(OnDisplayHeight { context ->
                DisplayUtils.rejectedNavHeight(
                    context
                )
            })
